...
Vue.component('button-counter', {
	...
	template: '<div class="am-panel-bd" >' +
		...
		'<div>' +
		'<div>' +
		'<div class="TASK_ID">{{this.count.row1}}<span :class="[\'taskid_from\', this.count.statusText==\'即将超期\'?\'taskid_from_backg_two\':\'taskid_from_backg_one\']">{{this.count.row1Value}}</span></div>' +
		'</div>' +
